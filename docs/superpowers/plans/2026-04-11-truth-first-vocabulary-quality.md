...
- 公開語彙数: `15175`
- `data/editorial-overrides.json`: `8530` 件
- 内訳: `approved 7969`、`rejected 561`
- Level 1: `10787` 件、reviewed `7398`、unreviewed `3389`
- Level 2: `1116` 件、reviewed `401`、unreviewed `715`
