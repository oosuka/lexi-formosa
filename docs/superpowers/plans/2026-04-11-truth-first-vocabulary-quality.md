...
- 公開語彙数: `15189`
- `data/editorial-overrides.json`: `7030` 件
- 内訳: `approved 6483`、`rejected 547`
- Level 1: `10801` 件、reviewed `6039`、unreviewed `4762`
- Level 2: `1116` 件、reviewed `274`、unreviewed `842`
