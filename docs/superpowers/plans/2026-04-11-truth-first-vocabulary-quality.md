...
- 公開語彙数: `15214`
- `data/editorial-overrides.json`: `5530` 件
- 内訳: `approved 5008`、`rejected 522`
- Level 1: `10826` 件、reviewed `4621`、unreviewed `6205`
- Level 2: `1116` 件、reviewed `217`、unreviewed `899`
