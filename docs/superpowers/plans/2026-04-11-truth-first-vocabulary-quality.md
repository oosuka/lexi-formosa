...
- 公開語彙数: `15165`
- `data/editorial-overrides.json`: `11030` 件
- 内訳: `approved 10459`、`rejected 571`
- Level 1: `10777` 件、reviewed `9511`、unreviewed `1266`
- Level 2: `1116` 件、reviewed `778`、unreviewed `338`
