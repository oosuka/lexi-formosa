...
- 最新コミット: `90b606c 壊れた語彙ラベルの横断除去を反映`
- 公開語彙数: `15650`
- `data/editorial-overrides.json`: `1356` 件
- 内訳: `approved 1270`、`rejected 86`
- Level 1: `10864` 件、reviewed `1191`、unreviewed `9673`
- Level 2: `1120` 件、reviewed `69`、unreviewed `1051`
- Level 3: `3666` 件、reviewed `10`、unreviewed `3656`
- Level 3 内訳: 5文字 `2566`、6文字 `1100`
- Level 3 MJdic 単独: `3647`
- Level 3 の日本語ラベル 13文字以上: `328`
- `audit:data` の現状: `reference_only: 0`、`corrupted_japanese_gloss: 0`
...
次に実装するのは、通常レビューと Level 3 high-risk review を分けて走らせるための監査・export 強化。
...
- [ ] **Step 3: Implement minimal signal functions**
...
- [ ] **Step 1: Write failing test for Level 3 high-risk routing**
...
- [ ] **Step 2: Write regression test for Level 1-2 normal routing**
...
- [ ] **Step 4: Implement batch options**
...
- [ ] **Step 1: Export a focused Level 3 high-risk batch**
...
- [ ] **Step 2: Review Level 3 with Truth-first Challenge rules**
...
- [ ] **Step 3: Export the normal Level 1-2 batch**
...
- [ ] **Step 4: Review Level 1-2 with Core rules**
...
- [ ] **Step 2: Confirm old plans stay discarded**
