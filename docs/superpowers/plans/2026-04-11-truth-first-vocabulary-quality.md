...
- 最新作業: `2026-04-12 Level 1-2 normal batch 500 件を追加処理（承認 494 件、却下 6 件）`
- 公開語彙数: `15194`
- `data/editorial-overrides.json`: `6530` 件
- 内訳: `approved 5988`、`rejected 542`
- Level 1: `10806` 件、reviewed `5560`、unreviewed `5246`
- Level 2: `1116` 件、reviewed `258`、unreviewed `858`
