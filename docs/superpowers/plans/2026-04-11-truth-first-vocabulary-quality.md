...
- 最新作業: `2026-04-12 Level 1-2 normal batch 500 件を追加処理（承認 486 件、却下 14 件）`
- 公開語彙数: `15200`
- `data/editorial-overrides.json`: `6030` 件
- 内訳: `approved 5494`、`rejected 536`
- Level 1: `10812` 件、reviewed `5083`、unreviewed `5729`
- Level 2: `1116` 件、reviewed `241`、unreviewed `875`
