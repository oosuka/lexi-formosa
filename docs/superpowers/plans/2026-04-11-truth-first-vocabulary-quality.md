...
- 公開語彙数: `15174`
- `data/editorial-overrides.json`: `9530` 件
- 内訳: `approved 8968`、`rejected 562`
- Level 1: `10786` 件、reviewed `8243`、unreviewed `2543`
- Level 2: `1116` 件、reviewed `555`、unreviewed `561`
