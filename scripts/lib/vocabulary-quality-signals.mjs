...
const levelThreeProperNounRiskPatterns = [
  /(?:道庁所在地|自治区|自治州|省庁|運輸省|王朝|初代王|事件|戦役|番組)/u,
  /(?:大学|公司|有限公司)/u,
  /(?:の都市|首都|[ァ-ヶー一-龯]{2,}(?:省|州|県|郡|市))/u,
  /(?:サッカークラブ|フットボールクラブ|野球クラブ)/u,
];
...
export const isLevelThreeProperNounRiskGloss = (gloss) =>
  levelThreeProperNounRiskPatterns.some((pattern) => pattern.test(gloss));
